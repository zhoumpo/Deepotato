"""
UI application for controlling the deep learning agent.
"""
        ...
        if self.agent:
            ...
            if hasattr(self.agent, "last_game_state") and self.agent.last_game_state:
                ...
                if "player" in game_state and "health" in game_state["player"]:
                    ...
                    self.player_health_var.set(f"{health['current']}/{health['max']}")
            ...
            if self.agent.last_action is not None:
                ...
                self.last_action_var.set(action_names.get(self.agent.last_action, "Unknown"))
        
        # Schedule the next update
        self.update_timer = self.root.after(500, self.update_ui)
